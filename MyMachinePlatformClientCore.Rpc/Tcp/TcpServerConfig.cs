...
public interface ITcpServerConfig : ITcpConfig
{
    ...
    /// </summary>
    bool AllowCrossGroupMessage { get; set; }
}

/// <summary>
/// Represents a tcp server configuration object.
/// </summary>
internal class TcpServerConfig : TcpConfig, ITcpServerConfig
{
    /// <summary>
