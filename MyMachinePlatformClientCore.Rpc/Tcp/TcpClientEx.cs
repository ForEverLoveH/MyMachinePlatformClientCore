...
public class TcpClientEx : TcpBase
{
    ...
    /// </summary>
    public ITcpClientConfig ClientConfig
    {
        get { return (ITcpClientConfig)_tcpConfig; }
    }
    ...
    private void BeforeConnect(string strIp, int nPort)
    {
    ...
    public void SetTcpClientParam(ITcpClientConfig clientConfig)
    {
    ...
    public void ConnectAsync(string ipAddress, int port, int timeout, Action<bool> callback)
    {
        ...
        BeforeConnect(ipAddress, port);
        ConnectAsyncInner(callback);
    }

    public bool IsConnected=> _clientSocket != null && _clientSocket.Connected;

    public IPEndPoint LocalEndPoint=>_clientSocket.LocalEndPoint as IPEndPoint;
