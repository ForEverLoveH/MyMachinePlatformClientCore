...
public class WebSocket:IWebSocket
{
    ...
    /// <summary>
    /// WebSocket close frame header
    /// </summary>
    public const byte WS_CLOSE= 0x08;
    /// <summary>
    /// WebSocket ping frame header
    /// </summary>
    public const byte WS_PING= 0x09;
    /// <summary>
    /// WebSocket pong frame header
    /// </summary>
    ...
    /// 
    /// </summary>
    private void ClearWsBuffers()
    { 
        bool flag=false;
        try
        {
            Monitor.TryEnter(WsReceiveLock, ref flag);
            if (flag)
            {
                WsFrameReceived = false;
                WsFinalReceived = false;
        ...
        {
            if(flag) Monitor.Exit(WsReceiveLock);
        }
