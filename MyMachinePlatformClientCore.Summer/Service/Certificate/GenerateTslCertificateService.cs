...
{
    public class GenerateTslCertificateService : IGenerateTslCertificateService
    {
        ...
        public GenerateTslCertificateService(DateTime startTime, DateTime endTime, string password, string userName, string friendlyName)
        {
