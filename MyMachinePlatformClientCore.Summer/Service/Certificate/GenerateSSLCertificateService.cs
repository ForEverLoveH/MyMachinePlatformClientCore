...
namespace MyMachinePlatformClientCore.Summer.Service 
{
    ...
    /// 
    /// </summary>
    public class GenerateSSLCertificateService : IGenerateSSLCertificateService
    {
        /// <summary>
        /// 证书生效时间
        /// </summary>
        ...
        public GenerateSSLCertificateService(DateTime loseEffect, string password, string friendlyName)
        {
            ...
            ArrayList list = new ArrayList
        {
            ...
            return new X509Name(list, hashtable);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="pfxPath"></param>
        /// <param name="password"></param>
        public void FixPfxCertificatePasswrod(string pfxPath, string newPassword)
        {
            // 加载现有的PFX证书
            X509Certificate2 pfx = new X509Certificate2(pfxPath, this.password, X509KeyStorageFlags.Exportable);

            // 使用新密码导出PFX证书
            byte[] newPfxBytes = pfx.Export(X509ContentType.Pfx, newPassword);
